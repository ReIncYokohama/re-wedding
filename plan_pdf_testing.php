					...
					$key = $seat['id']."_input";
						...
						if($item_info['first_name']!='')
						{
							...
							if($seats_nums==0)
							{
								...
								$left_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td height=\"25\">";
								$left_string.="<span style=\"font-size:".$font_size_memo."%; \">".$memo."</span>";
								$left_string.="</td></tr><tr><td height=\"25\">";
							...
							else
							{
								...
								$right_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td height=\"25\">";
								$right_string.="<span style=\"font-size:".$font_size_memo."%;\">".$memo."</span>";
								$right_string.="</td></tr><tr><td height=\"25\">";
