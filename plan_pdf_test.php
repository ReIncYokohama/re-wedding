...
$html.='<td><table><tr><td colspan="2"><table><tr><td style="border:1px solid black;"  height="10"  width="50" >商品名</td>';
...
$gift_rows = $obj->GetAllRowsByCondition("spssp_gift"," user_id=".$user_id);
	...
	foreach($gift_rows as $gift)
	{
  		...
  		$html.='<tr><td  style="border:1px solid black;" height="10" width="50">'.$gift['name'].'</td>';
		...
		foreach($group_rows as $grp)
		{
			...
			{
				$htm = "<table cellpadding=\"1\"><tr><td><img  src=\"./admin/img/tick.jpg\" border=\"0\" width=\"7\"/></td></tr></table>";
          ...
          $html.='<td  style="text-align:center;border:1px solid black;"  width="20">&nbsp;</td>
		    ...
		    $html.='<tr>
            <td  style="text-align:center;border:1px solid black;"  height="10"  width="50">グループ数</td>';
					...
					$key = $seat['id']."_input";
						...
						if($item_info['first_name']!='')
						{
							...
							$chr_in_memo=mb_strlen($memo);
								...
								$font_size_comment=$font_size_menu_name=$font_size_memo=min($font_size_comment,$font_size_menu_name,$font_size_memo);
							...
							if($seats_nums==0)
							{
								...
								$left_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td  style=\"font-size:".$font_size_memo."%; \">";
								$left_string.=$memo;
								$left_string.="</td></tr><tr><td style=\"font-size:".$font_size_menu_name."%;\">";
								
								$left_string.=$menu_name;
								$left_string.="</td></tr><tr><td style=\"font-size:".$font_size_fullname."%;\">";
								$left_string.=$gift_groups;
								$left_string.="</td></tr></table>";
								
								
								$middle_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td   style=\"font-size:".$font_size_comment."%;padding:0; margin:0;\" >".$item_info['comment1']."</td></tr><tr><td style=\"font-size:".$font_size_comment."%;padding:0; margin:0;\">".$item_info['comment2']."</td></tr><tr><td   style=\"font-size:".$font_size_fullname."%;padding:0; margin:0;\">";
								
								$middle_string.=$item_info['first_name']." ".$item_info['last_name']." ".$rspct."</td></tr></table>";
								
								
								$html2.="<td width=\"52.63%\">
								<table   cellspacing=\"0\" cellpadding=\"0\" ><tr>
								
								<td valign=\"middle\" style=\"width:27.5%; text-align:center; border:1px solid black;\">".$left_string."</td><td style=\" width:63.5%;text-align:left;   border:1px solid black; \">".$middle_string."</td><td style=\"width:10%;  border:1px solid black;\">&nbsp;</td>
								</tr>
								</table>
								</td>";
							}
							else
							{
								...
								$right_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td  style=\"font-size:".$font_size_memo."%; \">";
								$right_string.=$memo;
								$right_string.="</td></tr><tr><td style=\"font-size:".$font_size_menu_name."%;\">";
								
								$right_string.=$menu_name;
								$right_string.="</td></tr><tr><td style=\"font-size:".$font_size_fullname."%;\">";
								$right_string.=$gift_groups;
								...
								<table   cellspacing=\"0\" cellpadding=\"0\" ><tr>
								<td   style=\"width:69.44%;text-align:left;   border:1px solid black; \">".$middle_string."</td><td  valign=\"middle\" style=\"width:31.56%;text-align:center;  border:1px solid black;  \">".$right_string."</td>
								</tr>
								</table>
								</td>";
							}
