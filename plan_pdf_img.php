...
$html.='<td><table style="border:1px solid black; padding:10px;"><tr><td align="center"  valign="middle" style="text-align:center;">新郎<br/>'.$user_info['man_lastname'].'</td><td align="center"  valign="middle" style="text-align:center;">新婦<br/>'.$user_info['woman_lastname'].' </td></tr></table><br/>

			<table>
				<tr>
					<td align="left"  valign="middle" style="text-align:center;">
					新郎様側: '.$man_lastname.'家&nbsp;&nbsp;&nbsp;&nbsp;列席者数 :'.$male_guest_num.'名様 
					&nbsp;&nbsp;&nbsp;&nbsp;
					新婦様側: '.$woman_lastname.'家&nbsp;&nbsp;&nbsp;&nbsp;列席者数:'.$female_guest_num.'名様 
					</td>
				</tr>
				<tr>
...
$i=1;
					...
					$key = $seat['id']."_input";
						...
						if($item_info['first_name']!='')
						{
							...
							if($seats_nums==0)
							{
								...
								$left_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td>";
								$left_string.="<span style=\"font-size:".$font_size_memo."%; \">".$memo."</span>";
								$left_string.="</td></tr><tr><td>";
								
								$left_string.="<span style=\"font-size:".$font_size_menu_name."%;\">".$menu_name."</span>";
								$left_string.="</td></tr><tr><td>";
								$left_string.="<span style=\"font-size:".$font_size_fullname."%;\">".$gift_groups."</span>";
								...
								$middle_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td  style=\"padding:0; margin:0;\"><span style=\"font-size:".$font_size_comment."%;padding:0; margin:0;\" >".$objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="comment1.png",$extra="guest/".$item_info['id']."/thumb1")."</span></td></tr><tr><td  style=\"padding:0; margin:0;\"><span style=\"font-size:".$font_size_comment."%;padding:0; margin:0;\" >".$objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="comment2.png",$extra="guest/".$item_info['id']."/thumb1")."</span></td></tr><tr><td  style=\"padding:0; margin:0;\">";
								
								$middle_string.="<b style=\"font-size:".$font_size_fullname."%;padding:0; margin:0;\" >".$objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$item_info['id']."/thumb1")."</b></td></tr></table>";
								
								
								$html2.="<td width=\"52.63%\">
								<table   cellspacing=\"0\" cellpadding=\"0\" ><tr>
								
								<td valign=\"middle\" style=\"width:27.5%; text-align:center;\">".$left_string."</td><td style=\" width:63.5%;text-align:left; \">".$middle_string."</td><td style=\"width:10%;\">&nbsp;</td>
								</tr>
								</table>
								</td>";
							}
							else
							{
								...
								$right_string.="<table cellspacing=\"0\" cellpadding=\"0\"><tr><td>";
								$right_string.="<span style=\"font-size:".$font_size_memo."%;\">".$memo."</span>";
								$right_string.="</td></tr><tr><td>";
								
								$right_string.="<span style=\"font-size:".$font_size_menu_name."%;\">".$menu_name."</span>";
								$right_string.="</td></tr><tr><td>";
								$right_string.="<span style=\"font-size:".$font_size_fullname."%;\">".$gift_groups."</span>";
								...
								<table   cellspacing=\"0\" cellpadding=\"0\" ><tr>
								<td   style=\"width:69.44%;text-align:left;\">".$middle_string."</td><td  valign=\"middle\" style=\"width:31.56%;text-align:center;\">".$right_string."</td>
								</tr>
								</table>
								</td>";
							}
 ...
 $html.="<tr><td><img src=\"name_image/royal-park/user_name/310/guest/841/thumb1/guest_fullname.png\"></td></tr></table>";
