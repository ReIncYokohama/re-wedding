...
class Core_Mysql{
  ...
  //
  // remove_remarks will strip the sql comment lines out of an uploaded sql files//
  ...
  public static function load_sql($sql_file,$mysql_user,$mysql_password,$mysql_database){
    $dbms_schema = $sql_file;
    
    $sql_query = @fread(@fopen($dbms_schema, 'r'), @filesize($dbms_schema)) or die('problem ');
    $sql_query = Core_Mysql::remove_remarks($sql_query);
    $sql_query = Core_Mysql::split_sql_file($sql_query, ';');
