...
<div class="clear"></div></div>
  ...
  <tr>
    <td>&nbsp;</td>
			...
			<td align="center" width="76"><input type="text" name="first_name" size="10" style="padding-top:3px; padding-bottom:3px;" id="first_name" <?php if($guest_row['self']==1){echo "disabled";}?> value="<?=$guest_row['first_name']?>" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center" width="76" ><input type="text" size="10"  style="padding-top:3px; padding-bottom:3px;" name="last_name" id="last_name" <?php if($guest_row['self']==1){echo "disabled";}?> value="<?=$guest_row['last_name']?>" /></td>
			</tr>
			<tr>
			...
			<td width="283" colspan="2" align="right" valign="top" ><table width="315" border="0" cellspacing="2" cellpadding="2">
			  <tr>
			    <td width="94" align="center"><input type="button" value="外字検索" onclick="m_win('./gaiji/source/palette.html','mywindow7',500,500); return false;" /></td>
		  ...
		  <tr>
			...
			<td colspan="2"><table width="189" border="0" cellspacing="2" cellpadding="2">
			  <tr>
			    <td width="100" align="right">肩書 1:</td>
			    <td width="75"><input  name="comment1" type="text" id="comment1" style="padding-top:3px; padding-bottom:3px;" value="<?=$guest_row['comment1']?>" size="10" maxlength="40" <?php if($guest_row['self']==1){echo "disabled";}?>/></td>
		      </tr>
</table>			  </td>
			<td><table width="180" border="0" cellspacing="2" cellpadding="2">
			  <tr>
			    <td width="90" align="right">肩書 2:</td>
			    <td width="76" align="center"><input  name="comment2" type="text" id="comment2" style="padding-top:3px; padding-bottom:3px;" value="<?=$guest_row['comment2']?>" size="10" maxlength="40" <?php if($guest_row['self']==1){echo "disabled";}?>/></td>
		      </tr>
		    </table></td>
		...
		<td width="96" align="right" valign="top"> <table width="96" border="0" cellspacing="2" cellpadding="2">
          ...
          <td valign="top"> <table width="180" border="0" cellspacing="2" cellpadding="2">
                        ...
                        <td width="283" colspan="2" align="right" valign="top" ><table width="313" border="0" cellspacing="2" cellpadding="2">
                          <tr>
                            <td width="94" align="right">&nbsp;</td>
                            <td width="76" align="right">高砂席名:</td>
		  ...
		  <tr>
			...
			<img src="admin/img/common/btn_regist.jpg" alt="登録" width="62" height="22" border="0">
			</a>
			&nbsp;&nbsp;
			...
			<img width="62" height="22" border="0" src="admin/img/common/btn_clear.jpg" alt="ｸﾘｱ">
			</a>
			</td>
      ...
      <table width="860" border="0" cellspacing="1" cellpadding="3">
        <tr>
          ...
          <td width="84" rowspan="3">
		  		<input type="checkbox" name="sex_sort" <?php if($ordervalue[0]=="sex") { ?> checked <?php } ?> value="sex" id="sexsearch" />新郎新婦側<br />
		   		<input type="checkbox" name="guest_type_sort"  <?php if($ordervalue[1]=="guest_type") { ?> checked <?php } ?> value="guest_type" id="guset_typesearch" />区分<br />
          ...
          <td width="114" rowspan="3" valign="middle"><input type="button" onclick="gsearch();" value="ソート" /> &nbsp; &nbsp; 
		  <a href="my_guests.php"><img width="62" height="22" border="0" alt="ｸﾘｱ" src="admin/img/common/btn_clear.jpg"></a>
		</td>
