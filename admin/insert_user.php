...
if(isset($user_id) && $user_id > 0)
  {
    ...
    set_user_gaiji_position($user_id,$post["man_firstname"],0,$_POST["male_first_gaiji_img"]);
    set_user_gaiji_position($user_id,$post["man_lastname"],1,$_POST["male_last_gaiji_img"]);
    set_user_gaiji_position($user_id,$post["woman_firstname"],2,$_POST["female_first_gaiji_img"]);
    set_user_gaiji_position($user_id,$post["woman_lastname"],3,$_POST["female_last_gaiji_img"]);
