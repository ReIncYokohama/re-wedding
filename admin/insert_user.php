...
if(isset($user_id) && $user_id > 0)
  {
    ...
    //ゲストとして新郎を登録
    make_guest_images($user_id,$man_guest_id,$post["man_lastname"],$post["man_firstname"],$gueest_array["comment1"],"","様",
                      $_POST["male_last_gaiji_img"],$_POST["male_first_gaiji_img"],array(),array());

    //ゲストとして新婦を登録    
    make_guest_images($user_id,$woman_guest_id,$post["woman_lastname"],$post["woman_firstname"],$gueest_array2["comment1"],"","様",
