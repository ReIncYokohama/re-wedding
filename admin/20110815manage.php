...
?>
			...
			foreach($data_rows as $row)
			{
				...
				include("inc/main_dbcon.inc.php");
				$man_respect = $obj->GetSingleData(" wplus_main.spssp_respect", " title", " id=".(int)$data_rows['man_respect_id']);
				$woman_respect = $obj->GetSingleData(" wplus_main.spssp_respect", " title", " id=".(int)$data_rows['woman_respect_id']);
				include("inc/return_dbcon.inc.php");
...
<!--                        <p>■管理会社より -News- &nbsp;&nbsp;&nbsp;<a href="javascript:void()" onclick="add_supper_message();">メッセージ作成 </a></p> -->
							...
							<ul class="ul3" id="message_BOX" style="height:200px; overflow:auto;">
								...
								include("inc/main_dbcon.inc.php");
								$super_messeges = $obj->GetAllRowsByCondition(" wplus_main.super_admin_message "," 1 = 1 order by id desc");
								include("inc/return_dbcon.inc.php");
