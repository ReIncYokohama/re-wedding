...
?>
		   ...
		   <div class="box_table" id="box_table">
            ...
            <div class="box4" style="width:1200px;">
                <table border="0" align="center" cellpadding="1" cellspacing="1" >
                    <tr align="center">
                        ...
                        <td width="150"> 新郎氏名<span class="txt1"><a href="manage.php?order_by=woman_last_name&asc=true">▲</a> 
                        	<a href="manage.php?order_by=woman_last_name&asc=false">▼</a></span>
                         </td>
                        <td width="150">新婦氏名<span class="txt1"><a href="manage.php?order_by=man_last_name&asc=true">▲</a> 
...
?>	
			...
			{	
				...
				$last_login = $obj->GetSingleRow("spssp_user_log", " user_id=".$row['id']." ORDER BY login_time DESC");
			...
			?>
              <div class="<?=$class?>" style="width:1200px;">
                <table border="0" align="center" cellpadding="1" cellspacing="1">
                    <tr align="center">
                    	<td width="62"><a href="user_info.php?user_id=<?=$row['id']?>"><img src="img/common/customer_info.gif" width="62" height="17" /></a></td>
                         <!--<td><?php //echo $obj->japanyDateFormate($row['party_day'] , $row['party_day_with_time'])?></td>-->
						 <td  width="110"><?=$obj->japanyDateFormateShort($row['party_day'] )?></td>

                        <td width="150"><?=$row['man_firstname']." ".$row['man_lastname'].' 様';?></td>
                        <td width="150"><?=$row['woman_firstname']." ".$row['woman_lastname'].' 様';?></td>
                        <td class="txt1" width="62">
