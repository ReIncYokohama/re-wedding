...
<!-- UCHIDA EDIT 11/08/05 左寄せなどその他の修正  -->
        ...
        <table width="800" border="0" cellspacing="10" cellpadding="0">
            <tr>
                <td valign="top" nowrap="nowrap" width="50" style="text-align:left;" >挙式日<font color="red">*</font>　　　　　　　　　&nbsp;：</td>
            ...
            <tr>
                ...
                <td width="92%" nowrap="nowrap" colspan="3">
                   <input name="man_firstname" type="text" style="padding-top:4px; padding-bottom:4px;" id="man_firstname" value="<?=$user_row['man_firstname']?>" size="30"  onclick="change_gaiji_link('man_firstname')" /> 
                	...
                	様　 <a onclick="m_win(this.href,'mywindow7',500,500); return false;" href="../gaiji/palette.php"><img src="img/common/btn_gaiji.jpg" width="82" height="22"alt="外字検索" title="外字検索" /></a>
                </td>
            ...
            <tr>
                ...
                <td align="left" nowrap="nowrap">挙式種類<font color="red">*</font>　　　　　　　　&nbsp;：</td>
                <td nowrap="nowrap">
...
<!-- UCHIDA EDIT 11/08/03  <option value=""  <?php if($user_row[religion]=='') {?> selected="selected" <?php } ?>>選択してください</option> -->
            ...
            <tr>
                <td align="left" valign="top" nowrap="nowrap">披露宴会場<font color="red">*</font>　　　　　　　&nbsp;：</td>
                <td nowrap="nowrap">
            ...
            <tr>
                <td align="left" valign="top" nowrap="nowrap">ログインID<font color="red">*</font>　　　　　　　&nbsp;：</td>
                <td colspan="3" nowrap="nowrap">
            ...
            <tr>
                <td align="left" valign="top" nowrap="nowrap">お客様パスワード<font color="red">*</font>　　　　&nbsp;：</td>
		...
		<input type="radio" name="rename_table" id="radio0" value="0" <?php if($user_plan_row['rename_table'] == "0"){echo "checked='checked'";}?> /> 不可
            ...
            <tr>
				...
				<?=$dateBeforeparty?>  <?=$limitation_ranking?>&nbsp;日前</td>
