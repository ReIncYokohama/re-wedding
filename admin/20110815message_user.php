	...
	?>
		<div class="<?=$class?>">
            ...
            <tr align="center">
              ...
              <td><div id="view_<?=$row['id']?>"><?php if($row['admin_viewed']==0){?><a href="javascript:void(0)" onclick="view_adminitem(<?=$row['id']?>,<?=$view?>);"><img src="img/common/btn_midoku.gif" id="view<?=$row['id']?>" width="42" height="17" /></a><?php }?></td>
              <!-- < ?php if($row['admin_id']){
              ...
              <td><a href="#" onclick="view_adminitem(<?=$row['id']?>,<?=$view?>);"><img src="img/common/btn_honbun.gif" width="42" height="17" /></a></td>
...
function view_adminitem(id,view){
	if(view==1)
	{
