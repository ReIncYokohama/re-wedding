...
function valid_user()
{
	if(document.getElementById("man_firstname").value=='' && document.getElementById("man_firstname_eng").value=='')
	{
		alert("新郎の姓を正しく入力してください");
		if(document.getElementById("man_firstname").value=='')
			document.getElementById('man_firstname').focus();
		if(document.getElementById("man_firstname_eng").value=='')
			document.getElementById('man_firstname_eng').focus();
		return false;
	}

	if(document.getElementById("man_lastname").value=='' && document.getElementById("man_lastname_eng").value=='')
	{
		alert("新郎の名を正しく入力してください");
		if(document.getElementById("man_lastname").value=='')
			document.getElementById('man_lastname').focus();
		if(document.getElementById("man_lastname_eng").value=='')
			document.getElementById('man_lastname_eng').focus();
		return false;
	}
	if(document.getElementById("man_furi_firstname").value=='' && document.getElementById("man_furi_firstname_eng").value=='')
	{
		...
		if(document.getElementById("man_furi_firstname_eng").value=='')
			document.getElementById('man_furi_firstname_eng').focus();
		return false;
	}
	if(document.getElementById("man_furi_lastname").value=='' && document.getElementById("man_furi_lastname_eng").value=='')
	{
		...
		if(document.getElementById("man_furi_lastname_eng").value=='')
			document.getElementById('man_furi_lastname_eng').focus();
		return false;
	}

	if(document.getElementById("woman_firstname").value=='' && document.getElementById("woman_firstname_eng").value=='')
	{
		alert("新婦の姓を正しく入力してください");
		if(document.getElementById("woman_firstname").value=='')
			document.getElementById('woman_firstname').focus();
		if(document.getElementById("woman_firstname_eng").value=='')
			document.getElementById('woman_firstname_eng').focus();
		return false;
	}

	if(document.getElementById("woman_lastname").value=='' && document.getElementById("woman_lastname_eng").value=='')
	{
		alert("新婦の名を正しく入力してください");
		if(document.getElementById("woman_lastname").value=='')
			document.getElementById('woman_lastname').focus();
		if(document.getElementById("woman_lastname_eng").value=='')
			document.getElementById('woman_lastname_eng').focus();
		return false;
	}
	if(document.getElementById("woman_furi_firstname").value=='' && document.getElementById("woman_furi_firstname_eng").value=='')
	{
		...
		if(document.getElementById("woman_furi_firstname_eng").value=='')
			document.getElementById('woman_furi_firstname_eng').focus();
		return false;
	}
	if(document.getElementById("woman_furi_lastname").value=='' && document.getElementById("woman_furi_lastname_eng").value=='')
	{
		...
		if(document.getElementById("woman_furi_lastname_eng").value=='')
			document.getElementById('woman_furi_lastname_eng').focus();
		return false;
	}
...
/**************************LIKHON*******START*************************/
function changePatter(idFstJp,idLstJp,idFstEng,idLstEng)
{
	//alert(idFstJp);
	$j('#'+idFstJp).attr("value", "");
	$j('#'+idFstJp).attr("disabled", true);

	$j('#'+idLstJp).attr("value", "");
	$j('#'+idLstJp).attr("disabled", true);

	$j('#'+idFstEng).attr("value", "");
	$j('#'+idFstEng).attr("disabled", false);

	$j('#'+idLstEng).attr("value", "");
	$j('#'+idLstEng).attr("disabled", false);

	document.getElementById(idFstEng).focus();
}
    ...
    <div id="contents">
        ...
        <table width="100%" border="0" cellspacing="10" cellpadding="0">
            <tr>
                ...
                <td width="17%" nowrap="nowrap">
                    ...
                    <input name="man_lastname" type="text" id="man_lastname"  class="input_text"  />
					 様  <a href="#" onclick="changePatter('man_firstname','man_lastname','man_firstname_eng','man_lastname_eng');">Change pattern</a>
              	</td>
                <td width="15%" align="right" nowrap="nowrap">Groom Name：</td>
                <td nowrap="nowrap">
                   <input name="man_firstname_eng" type="text" id="man_firstname_eng"  class="input_text" disabled/>
                   <input name="man_lastname_eng" type="text" id="man_lastname_eng"  class="input_text"  disabled/>
				    様  <a href="#" onclick="changePatter('man_firstname_eng','man_lastname_eng','man_firstname','man_lastname');">Cancel pattern</a>
                </td>
            </tr>

            <tr>
                <td align="right" nowrap="nowrap">新婦氏名：</td>
                <td nowrap="nowrap">
                	<input name="woman_firstname" type="text" id="woman_firstname"  class="input_text"  />
                    <input name="woman_lastname" type="text" id="woman_lastname"  class="input_text"  />
					様  <a href="#" onclick="changePatter('woman_firstname','woman_lastname','woman_firstname_eng','woman_lastname_eng');">Change pattern</a>

                </td>

                <td align="right" nowrap="nowrap">Bride Name：</td>
                <td nowrap="nowrap">

                	<input name="woman_firstname_eng" type="text" id="woman_firstname_eng"  class="input_text"  disabled />
                    <input name="woman_lastname_eng" type="text" id="woman_lastname_eng"  class="input_text"  disabled />
					 様  <a href="#" onclick="changePatter('woman_firstname_eng','woman_lastname_eng','woman_firstname','woman_lastname');">Cancel pattern</a>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td nowrap="nowrap">
					...
					様 <a href="#" onclick="changePatter('man_furi_firstname','man_furi_lastname','man_furi_firstname_eng','man_furi_lastname_eng');">Change pattern</a>
                </td>

                <td align="right" nowrap="nowrap">Man furi：</td>
                <td nowrap="nowrap">
                	<input name="man_furi_firstname_eng" type="text" id="man_furi_firstname_eng"  class="input_text"  disabled/>
                    <input name="man_furi_lastname_eng" type="text" id="man_furi_lastname_eng"  class="input_text"   disabled/>
					様  <a href="#" onclick="changePatter('man_furi_firstname_eng','man_furi_lastname_eng','man_furi_firstname','man_furi_lastname');">Cancel pattern</a>
            ...
            <tr>
                ...
                <td nowrap="nowrap">
					...
					様  <a href="#" onclick="changePatter('woman_furi_firstname','woman_furi_lastname','woman_furi_firstname_eng','woman_furi_lastname_eng');">Change pattern</a>

                </td>

                <td align="right" nowrap="nowrap">Woman furi：</td>
                <td nowrap="nowrap">

                	<input name="woman_furi_firstname_eng" type="text" id="woman_furi_firstname_eng"  class="input_text" disabled />
                    <input name="woman_furi_lastname_eng" type="text" id="woman_furi_lastname_eng"  class="input_text" disabled />
					様  <a href="#" onclick="changePatter('woman_furi_firstname_eng','woman_furi_lastname_eng','woman_furi_firstname','woman_furi_lastname');">Cancel pattern</a>
                </td>
        ...
        <div class="box_table">
            ...
            <div class="<?=$class?>">
                <table border="0" align="center" cellpadding="1" cellspacing="1">
                    <tr align="center">
                    	<td><a href="user_info.php?user_id=<?=$row['id']?>"><img src="img/common/btn_detail.gif" width="42" height="17" /></a></td>
                        <td><?=$row['marriage_day'].",".date("D",mktime($row['marriage_day']))?></td>
                        <td><?php if($row['man_firstname']==""&&$row['man_lastname']==""){echo $row['man_firstname_eng']." ".$row['man_lastname_eng'].' 様';}else{echo $row['man_firstname']." ".$row['man_lastname'].' 様';}?></td>
                        <td><?php if($row['woman_firstname']==""&&$row['woman_lastname']==""){echo $row['woman_firstname_eng']." ".$row['woman_lastname_eng'].' 様';}else{echo $row['woman_firstname']." ".$row['woman_lastname'].' 様';}?></td>
                        <td class="txt1">
