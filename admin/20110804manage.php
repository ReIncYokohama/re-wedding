    ...
    <div id="contents">
       ...
       <div style="font-size:12px; font-weight:bold;">
        <ul class="ul2">
			...
			{
				echo $objMsg->get_admin_side_order_print_mail_system_status_msg($row['id']);
				echo $objMsg->get_admin_side_daylimit_system_status_msg($row['id']);
			}
			?>
			...
			<?php
            	...
            	foreach($usermsgs as $umsg)
				{
					...
					$user_name=$man_firstname." ".$woman_firstname;
        ...
        <h2>お客様一覧</h2>
            ...
            <div id="top_search_view">
			  ...
			  <tr style="height:30px;">
				<td width="80">披露宴日：</td>
				<td width="169"><input name="date_from" type="text" id="date_from"    style="background: url('img/common/icon_cal.gif') no-repeat scroll right center rgb(255, 255, 255); padding-right: 20px;" class="datepicker" /> </td>

				<!-- UCHIDA EDIT 11/07/26 -->
			    <!-- <td width="62" >～</td> -->
			    <td width="80" >～</td>

				<td width="389"><input name="date_to" type="text" id="date_to"   style="background: url('img/common/icon_cal.gif') no-repeat scroll right center rgb(255, 255, 255); padding-right: 20px;" class="datepicker"  /></td>
			  </tr>
			  <tr style="height:30px;">
				<td>新郎姓：</td>
			  ...
			  <tr>
				...
				<td height="40" valign="bottom" ><a href="javascript:void(0);" onclick="validSearch();"><img src="img/common/btn_search1.jpg" alt="search" /></a></td>
				<td align="left" valign="bottom" >
				<a href="javascript:void(0);" onclick="clearForm()"><img border="0" height="22" width="62" alt="ｸﾘｱ" src="img/common/btn_clear.jpg"></a></td>

			 	<td align="left" valign="bottom" ><a href="manage.php"><img src="img/common/new_userlist.gif"/></a></td> <!-- UCHIDA EDIT 11/07/26 -->

			  </tr>
			  <tr>
			    <td >&nbsp;</td>
			    <td height="40" > <a href="newuser.php"><img src="img/common/new_register.gif" alt="New Register"></a></td>
              ...
              <div class="<?=$class?>" style="width:1000px;">
                <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                    <tr align="center">
                        ...
                        <td width="147"><?=$row['man_firstname']." ".$row['man_lastname'].' 様';?></td>
                        <td width="146"><?=$row['woman_firstname']." ".$row['woman_lastname'].' 様';?></td>
