        ...
        <table width="100%" border="0" cellspacing="10" cellpadding="0" style="width:1000px;">
			...
			<tr>
                ...
                <td width="25%" nowrap="nowrap">
                	...
                	<input name="man_firstname" type="text" id="man_firstname"  class="input_text" onclick="change_gaiji_link('man_firstname')"  /> 様
 ...
 様
            ...
            <tr>
                ...
                <td nowrap="nowrap">
                	...
                	<input name="man_furi_firstname" type="text" id="man_furi_firstname"  class="input_text" /> 様
                ...
                <td nowrap="nowrap">
                	...
                	<input name="woman_furi_firstname" type="text" id="woman_furi_firstname"  class="input_text"  /> 様
                </td>
