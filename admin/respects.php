...
<div id="container">
	...
	<div id="contents">
        ...
        <div  id="new_table" style="display:none; width:100%;">
        	...
        	<form action="respects.php" method="post" name="new_name">
            	<input type="hidden" name="insert_edit" id="insert_edit" value="0" />
                	タイトル : &nbsp;<input type="text" name="title" id="name"  /> &nbsp; &nbsp; &nbsp;
        ...
        <p>&nbsp;</p>
        <div id="box_table" style="height:450px; overflow:auto;">
            <div class="box4">
            ...
            <?php
            	$query_string="SELECT * FROM spssp_respect  ORDER BY title asc ;";
