...
<div id="container">
	...
	<h2><div style="width:450px;">席次表・席札 &raquo; 基本設定</div></h2>
	  ...
	  <div style="width:600px; border:1px solid #fff" >
	  ...
	  <input type="hidden" name="insert_edit" value="<?=$_GET[id]?>"  />
		  ...
		  <tr>
			<td style="text-align:center;height:20px;vertical-align:middle; background:#4F81BD; color:#fff; width:200px; font-size:13px;">校了日設定</td>
			<td style=" text-align:center;height:20px;vertical-align:middle; background:#4F81BD; color:#fff; width:200px; font-size:13px;">席次表編集利用制限日</td>
 		  </tr>
		  <tr>
			<td valign="middle" style=" vertical-align:middle; text-align:center; height:40px;">
				<input type="text" name="confirm_day_num" id="confirm_day_num" size="5" maxlength="2" onblur="isInteger('confirm_day_num')" value="<?=$confirm_day_num?>" />&nbsp;日前</td>
			<td valign="middle" style=" vertical-align:middle; text-align:center; height:40px;">
				<input type="text" name="limitation_ranking" id="limitation_ranking" size="5" maxlength="2" onblur="isInteger('limitation_ranking')" value="<?=$limitation_ranking?>" />&nbsp;日前
			</td>
		  </tr>
		  <tr>
		    <td colspan="2" align="center" style="text-align:center;height:20px;vertical-align:middle; background:#4F81BD; color:#fff;height:20px; font-size:13px;">&nbsp;&nbsp;卓名設定 </td>
		  </tr>
		  <tr>
		    <td colspan="2" >
				<table width="100%" border="0" cellspacing="1" cellpadding="4">
				  <tr>
					...
					<td width="191" align="left" valign="middle"><input type="text" name="default_layout_title"  id="DefaultLayoutTitle" value="<?=$default_layout_title?>" /></td>
					<td width="83" align="right" valign="middle">卓名変更:</td>
					<td width="206" height="40" valign="middle" >&nbsp;<input type="radio" value="1" name="rename_table_view" <?php 	if($default_raname_table_view == 1){echo "checked='checked'";}?>>&nbsp;可&nbsp;&nbsp;
					<input type="radio" value="0" name="rename_table_view" <?php 	if($default_raname_table_view == "0"){echo "checked='checked'";}?>>&nbsp;不可&nbsp;&nbsp;</td>
				  </tr>
				  <tr>
					<td align="right"> 卓名 : </td>
					<td align="left"><input type="text" name="name" id="name"  value="<?=$_GET['name']?>" /></td>
					<td>&nbsp;</td>
					<td height="40">&nbsp;</td>
				  </tr>
				  <tr>
				  ...
				  <tr>
				    <td colspan="4" align="center" valign="middle"><a href="#"><img  onclick="validForm();"; border="0" height="22" width="62" alt="保存" src="img/common/btn_regist1.jpg"></a>　　<a href="#"><img  onclick="clearForm()"; border="0" height="22" width="62" alt="ｸﾘｱ" src="img/common/btn_clear.jpg"></a></td>
			      </tr>
				</table>
			</td>
		  </tr>
