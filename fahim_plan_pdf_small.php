...
$html.='<table style="font-size:'.$main_font_size.';"><tr><td>&nbsp;</td><td><table style="border:1px solid black; padding:10px;"><tr><td align="center"  valign="middle" style="text-align:center;">新郎<br/>'.$user_info['man_firstname'].' '.$user_info['man_lastname'].'</td><td align="center"  valign="middle" style="text-align:center;">新婦<br/>'.$user_info['woman_firstname'].' '.$user_info['woman_lastname'].' </td></tr></table></td><td>&nbsp;</td></tr></table><br/>';
...
<table style="padding:5px;">	<tr>
				...
				<tr>
					<td align="left"  valign="middle" style="text-align:center;">校了予定日 '.strftime('%Y年%m月%d日',strtotime($confirm_date_main)).' </td>
				</tr>
				<tr>
			...
			$html.='<table style="font-size:'.$main_font_size.';border:1px solid black; width:100%; padding:10px;"><tr><td align="center"  valign="middle" style="text-align:center;">'.$main_guest[3].'</td><td align="center"  valign="middle" style="text-align:center;">'.$main_guest[1].'</td><td align="center"  valign="middle" style="text-align:center;">'.$user_info['man_firstname']." ".$user_info['man_lastname'].'</td><td align="center"  valign="middle" style="text-align:center;">'.$main_guest[5].'</td><td align="center"  valign="middle" style="text-align:center;">'.$user_info['woman_firstname']." ".$user_info['woman_lastname'].'</td><td align="center"  valign="middle" style="text-align:center;">'.$main_guest[2].'</td><td align="center"  valign="middle" style="text-align:center;">'.$main_guest[4].'</td></tr></table><br/>';
					...
					$key = $seat['id']."_input";
						...
						if($item_info['first_name']!='')
						{
							...
							else
							{
								...
								$right_string.="<span style=\"font-size:".$font_size_fullname."%;\">".$gift_groups."</span><br/>";
