...
function jp_encode1($string)
	{
		$string=trim($string);
		//$string=stripslashes($string);
		$string=mb_convert_encoding($string, "UTF8", "JIS, eucjp-win, sjis-win");
		return $string;
	}
...
function inquery_mail($to,$mailbody,$mailbody2)
	...
	$message_array  =  array(1 => "保存されました", //Saved
							 ...
							 4 => "更新されました", //Updated
							 5 => "Your sub-order has been placed to the printing company.Soon they will send you a message.",
							   );
	$error_array  =  array(	  1  =>  "データベースエラー", //Database Error
							  ...
							  24 => "",
							  25 => "",
							  26 => "You need to select a Print Company.Please contact to your admin.",
