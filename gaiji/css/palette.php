...
<div style="position: relative;">
   <div style="position: absolute; top: 66px; left: 58px; width: 150px;">
	
		<input type="hidden" name="search" value="search">
		<input type="text" id="text" name="text" font-size="100%" style="back ground-color:#ffffff"
onfocus="this.style.backgroundColor='#ffb2d7'" onblur="this.style.backgroundColor='#ffffff'; write_search_item();" size="18" maxlength="10" value="<?=$search_item?>" />
<script type="text/javascript">
