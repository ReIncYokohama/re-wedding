...
<link href="js/tipTip_test.css" rel="stylesheet" type="text/css" />
...
if($objInfo->get_editable_condition($plan_row))
	{
?>
<script src="js/drag_n_drop_test.js" type="text/javascript"></script>
<?php
	}
?>
...
<div id="step_bt_area">
  <div class="step_bt"><a href="table_layout.php" onclick="return make_plan_check();"><img src="img/step_head_bt01.jpg" width="155" height="60" border="0" class="on" /></a></div>
  <div class="step_flow_img"><img src="img/step_flow.gif" width="25" height="60" /></div>
  <div class="step_bt"><a href="hikidemono.php" onclick="return make_plan_check();"><img src="img/step_head_bt02.jpg" width="155" height="60" border="0" class="on"/></a></div>
  <div class="step_flow_img"><img src="img/step_flow.gif" width="25" height="60" /></div>
  <div class="step_bt"><a href="my_guests.php" onclick="return make_plan_check()"><img src="img/step_head_bt03.jpg" width="155" height="60" border="0" class="on" /></a></div>
  <div class="step_flow_img"><img src="img/step_flow.gif" width="25" height="60" /></div>
  <div class="step_bt"><img src="img/step_head_bt04_on.jpg" width="155" height="60" border="0"/></div>
  <div class="step_flow_img"><img src="img/step_flow.gif" width="25" height="60" /></div>
  <div class="step_bt"><a href="order.php" onclick="return make_plan_check()"><img src="img/step_head_bt05.jpg" width="155" height="60" border="0" class="on" /></a></div>
...
<div class="cont_area" id="con_area_ie">
  ...
  <div  id="guests_conatiner" style="float:left; height:400px; width:100%; overflow:auto" >
				...
				?>
					...
					$types_guest=array();
					include("admin/inc/main_dbcon.inc.php");
					$guest_types = $obj->GetAllRow("dev2_main.spssp_guest_type");
					...
					<td width="90" align="center" style="text-align:left;">
					 ...
					 <div  id="tst" style="padding:0;width:100%;text-align:left;">
							<div class="<?=$class?>" id="item_<?=$guest['id']?>"  style="width:100px; padding:0;text-align:left;">
								<a href="javascript:void(0)" style="color:black; display:block;" id="tip_<?=$guest['id']?>" class="tooltip" title="<span style='font-size:14px'><?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="full_comment.png",$extra="guest/".$guest['id']."/thumb1");?></span><br/><span  style='font-size:14px'><?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$guest['id']."/thumb1");?></span>" >
								<input type="hidden" value="<?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="full_comment.png",$extra="guest/".$guest['id']."/thumb1");?>" class="comeent1_hidden" />
								
								<input type="hidden" value="<?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$guest['id']."/thumb1");?>" class="guest_name_hidden" />
								<!--<span style="display:none;font-size:<?=$fsize?>; text-align:left; "><?=$guest['comment1']?>&nbsp;<?=$guest['comment2']?></span><br/>-->
								<?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$guest['id']."/thumb2");?>
  ...
  <div id="make_plan_area">
  	<form action="insert_default_plan.php?user_id=<?=(int)$user_id?>&plan_id=<?=$plan_id?>" method="post" id="insert_plan" name="insert_plan">
			...
			{
				$main_guest[$witness_bride[stage_guest]]=$witness_bride['first_name']." ".$witness_bride['last_name'];

			}


			$html.='<table style="width:100%; " cellspacing="2"><tr><td align="center"  valign="middle" style="text-align:center;border:1px solid black; padding:7px;">'.$main_guest[3].'</td><td align="center"  valign="middle" style="text-align:center;border:1px solid black;padding:7px; ">'.$main_guest[1].'</td><td align="center"  valign="middle" style="text-align:center;border:1px solid black;padding:7px; ">'.$user_info['man_firstname']." ".$user_info['man_lastname'].'</td><td align="center"  valign="middle" style="text-align:center;border:1px solid black; padding:7px;">'.$main_guest[5].'</td><td align="center"  valign="middle" style="text-align:center;border:1px solid black; padding:7px;">'.$user_info['woman_firstname']." ".$user_info['woman_lastname'].'</td><td align="center"  valign="middle" style="text-align:center;border:1px solid black; padding:7px;">'.$main_guest[2].'</td><td align="center"  valign="middle" style="text-align:center;border:1px solid black;padding:7px; ">'.$main_guest[4].'</td></tr></table>';
                                    ...
                                    <div id="<?=$seat['id']?>" class="<?=$class?>" >
										...
										<div id="abc_<?=$seat['id']?>" class="gallery ui-helper-reset ui-helper-clearfix">
											...
											<div class="ui-widget-content ui-corner-tr" id="item_<?=$item_info['id']?>"   style="width:80px; height:30px;background-color:#F5F8E5;border:0;">
													...
													?>
													<a href="javascript:void(0)" id="ahref_<?=$seat['id']?>" style="color:black; display:block;" class="tooltip" title="<span  style='font-size:14px'><?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="full_comment.png",$extra="guest/".$item_info['id']."/thumb1");?></span><br/><span  style='font-size:14px'><?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$item_info['id']."/thumb1");?></span>">


													<input type="hidden" value="<?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="full_comment.png",$extra="guest/".$item_info['id']."/thumb1");?><" class="comeent1_hidden" />
												
													<input type="hidden" value="<?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$item_info['id']."/thumb1");?>" class="guest_name_hidden" />
													<?php echo $objInfo->get_user_name_image_or_src_from_user_side($user_id ,$hotel_id=1, $name="guest_fullname.png",$extra="guest/".$item_info['id']."/thumb2");?>
