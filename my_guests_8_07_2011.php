	...
	<div id="newgustform" style="width:873px; margin:auto; min-height:100px; padding-top:5px; display:block">
	 ...
	 <input type="hidden" name="id" id="id" value="<?=$_GET['gid']?>" />
	   <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td width="50" align="center" height="30">新郎新婦側 :</td>
			<td width="150" align="center" height="30">
				<select id="sex" name="sex" style="width:140px; padding-top:3px; padding-bottom:3px;" <?php if($guest_row['self']==1){echo "disabled";}?>>
			...
			<td width="50" height="30" style="width:30px;" align="right">姓:</td>
			
			<td align="center" width="150" height="30"><input type="text" name="first_name" style="padding-top:3px; padding-bottom:3px;" id="first_name" <?php if($guest_row['self']==1){echo "disabled";}?> value="<?=$guest_row['first_name']?>" /></td>
			<td align="center" width="50" height="30">名 :</td>
			<td align="center" width="150" height="30" ><input type="text" style="padding-top:3px; padding-bottom:3px;" name="last_name" id="last_name" <?php if($guest_row['self']==1){echo "disabled";}?> value="<?=$guest_row['last_name']?>" /></td>
			<td colspan="2" rowspan="3" align="center" >
			<table width="100%" border="0" cellspacing="1" cellpadding="2">
			  <tr>
				<td valign="middle" align="center"><input type="button" value="外字検索" onclick="m_win('./gaiji/source/palette.html','mywindow7',500,500); return false;" /></td>
				<td valign="top">
					<table width="100%" border="0" cellspacing="1" cellpadding="2">
					  <tr>
						<td>敬称:</td>
						<td>
						<select id="respect_id" name="respect_id" style="width:100px; padding-top:3px; padding-bottom:3px;" >
				...
				<option value="">なし</option>
					  ...
					  <tr>
						<td>特記 :</td>
						<td><input type="text" style="padding-top:3px; padding-bottom:3px; width:100px;"   name="memo" id="memo" maxlength="40" value="<?=$guest_row['memo']?>" /></td>
					  </tr>
					</table>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
			  <tr>
				<td align="right" width="125">高砂席名:</td>
				<td><select id="stage_guest" name="stage_guest" style="width:120px; padding-top:3px; padding-bottom:3px;" <?php if($guest_row['self']==1){echo "disabled";}?>>
			  ...
			  <tr>
			  <td>Test
			  <select name="gender_status" style="pdding-2px; width:50px" <?php if($guest_row['self'] !=1){echo "disabled";}?>>
			  
			  <option <?=($genderStatus =='1')?"selected":"";?> value="1">1</option>
			  <option <?=($genderStatus =='2')?"selected":"";?> value="2">2</option>
			  </select>
			  </td>
				<td  style="text-align:center"><a href="my_guests_takasago.html" onclick="m_win(this.href,'mywindow7',520,270); return false;"> 高砂席位置について</a></td>
		  ...
		  <tr>
			...
			<td align="center" width="50" height="30">区分 :</td>
			<td align="center" width="150" height="30" >
				<select id="guest_type" name="guest_type" style="width:140px; padding-top:3px; padding-bottom:3px;"  <?php if($guest_row['self']==1){echo "disabled";}?>>
					<?php
			...
			<td align="center" width="50" height="30">肩書 1 :</td>
			<td align="center" width="150" height="30" ><input type="text" style="padding-top:3px; padding-bottom:3px;"  name="comment1" id="comment1" maxlength="40" value="<?=$guest_row['comment1']?>" /></td>
			<td align="center" width="50" height="30">肩書 2 :</td>
			<td align="center" width="150" height="30" ><input type="text" style="padding-top:3px; padding-bottom:3px;"  name="comment2" id="comment2" maxlength="40" value="<?=$guest_row['comment2']?>" /></td>
		  </tr>
		
		
		
		<tr>
		<td align="center" width="50" height="30"> 引出物 </td>
                        <td align="center" width="150"> 
                        	<?php
								...
								echo "<select id='gift_group'  name='gift_group_id' style='width:140px; padding-top:3px; padding-bottom:3px;'  ".$access.">";
                        ...
                        <td align="center" width="50"> 料理 </td>
                        <td align="center" width="150">
                        	<?php
								...
								echo "<select id='menu_grp' name='menu_grp' style='width:140px; padding-top:3px; padding-bottom:3px;' ".$access."> ";
								echo "<option value='' >なし</option>";
							...
							?>                        </td>
						 <td align="center" width="50"> 席種別: </td>
                        <td align="center" width="150">
						
						<select id="stage" name="stage" style="width:140px;padding-top:3px; padding-bottom:3px;"  <?php if($guest_row['self']==1){echo "disabled";}?>>
		  ...
		  <tr>
			...
			<td valign="middle" height="30" colspan="2"  ><input type="button" value="保存" onclick="validForm()" /> <input type="button" value="クリア" onclick="resetButton()" /> </td>
		 	<td valign="middle" height="30" align="right" colspan="5" >
...
<br>
	...
	<table width="863" border="0" cellpadding="3" cellspacing="1" bgcolor="#999999" style="padding-top:1px">
	  ...
	  <tr>
			 ...
			 <?php
			 if($guest['stage_guest']>0)
			 {echo "<span style='color:red;'>";}
			 ?>
			 <?=$guest['first_name']?>
			  <?php if($guest['stage_guest']>0)
			 {echo "</span>";}?>
			 </td>
			 <td align="left" valign="middle" bgcolor="#FFFFFF">
			 <?php
		...
		$boyRows='<tr>
      		<td bgcolor="#FFFFFF">
            	<input  type="radio" value="" disabled="disabled"  '.$genderm.'/>    新郎<br />
          		<input  type="radio" value="" disabled="disabled"  '.$genderf.'/>    新婦
            </td>
             <td align="left" valign="middle" bgcolor="#FFFFFF"> '.$fristname.'</td>
			 <td align="left" valign="middle" bgcolor="#FFFFFF">'.$lastname.'</td>  
    ...
    <div class="cont_area">
      ...
      <table width="860" border="0" cellspacing="1" cellpadding="3">
        <tr>
          ...
          <td width="96" rowspan="3" align="center">&nbsp;</td>
          <td width="102" rowspan="3" align="center">&nbsp;</td>
