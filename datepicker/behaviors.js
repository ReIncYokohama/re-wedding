var rules = {
	...
	'input.datepicker': function(elt) {
		new Control.DatePicker(elt, { icon: 'datepicker/calendar.png', locale:'ahad' });
	},
	...
	'input.datetimepicker': function(elt) {
		new Control.DatePicker(elt, { icon: 'datepicker/calendar.png', locale:'ahad', timePicker: true, timePickerAdjacent: true, use24hrs: true });
		
	},
	'input.datetimepicker_es': function(elt) {
		new Control.DatePicker(elt, { icon: '/js/controls/datepicker/calendar.png', locale:'es_AR', timePicker: true });
	},
